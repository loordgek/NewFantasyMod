...
public final class ModItems
{
	...
	public static final RegistryObject<AxeItem> RAINBOW_AXE = ITEMS.register("rainbow_pickaxe", () -> new AxeItem(ModItemTier.FANTASY, 10, 7.5F, new Item.Properties().group(ModItemGroups.RAINBOW_MOD_GROUP)));
	public static final RegistryObject<HoeItem> RAINBOW_HOE = ITEMS.register("rainbow_pickaxe", () -> new HoeItem(ModItemTier.FANTASY, 5, new Item.Properties().group(ModItemGroups.RAINBOW_MOD_GROUP)));
