...
{	
	...
	public static final RegistryObject<Item> FULL_RAINBOW_PICKAXE = ITEMS.register("full_rainbow_pickaxe", () -> new PickaxeItem(ModItemTier.FANTASY, 12, 3F, new Item.Properties().group(ModItemGroups.RAINBOW_MOD_GROUP)));
